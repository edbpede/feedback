...
<div class="border-primary/20 bg-primary/5 mb-6 rounded-lg border px-4 py-3">
  ...
  <div class="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
    ...
    <div class="flex items-center gap-2">
      <span class="i-carbon-security text-primary text-lg"></span>
      ...
      {#each benefits as benefit (benefit.titleKey)}
        <Tooltip>
          <TooltipTrigger class="flex cursor-help items-center gap-1.5">
            <span class="{benefit.icon} text-primary text-sm"></span>
  ...
  <Collapsible>
    <CollapsibleTrigger class="text-muted-foreground hover:text-foreground group mt-2 flex w-full items-center justify-center gap-2 py-1 text-xs transition-colors">
      ...
      <span class="i-carbon-chevron-down text-xs transition-transform duration-200 group-data-[state=open]:rotate-180"></span>
    </CollapsibleTrigger>
    <CollapsibleContent>
